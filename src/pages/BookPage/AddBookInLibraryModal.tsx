...
import { ADD_BOOK_TO_LIBRARY, FAMILY_GET } from '../../config/urls';
...
const AddBookInLibraryModal = ({ onClose, bookId, usersDostnHaveBookInFamily }: IProps) => {
	...
	const usersOptions = useMemo(() => {
		...
		return data.users
			.filter((i) => usersDostnHaveBookInFamily.includes(i.id))
	...
	const mutation = useMutation({
		mutationFn: async () => {
			...
			queryClient.refetchQueries({ queryKey: [`book`, bookId] });
		},
	});
